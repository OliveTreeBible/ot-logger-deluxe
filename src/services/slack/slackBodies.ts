...
export class SlackBodies {
    ...
    private static _fillBody(body: string, title:string, structuredMessage: StructuredMessage, alertType: SlackAlertType): string {
        ...
        return body
            ...
            .replaceAll(SlackBodies.ALERT_TYPE_STRING, SlackBodies._getAlertTypeString(alertType, false))
            .replaceAll(SlackBodies.ALERT_TYPE_ICON, SlackBodies._getAlertTypeString(alertType, true))
            .replaceAll(SlackBodies.TIMESTAMP_STRING, moment().format('YYYY-MM-DD HH:mm:ss'))
            .replaceAll(SlackBodies.HOSTNAME_STRING, os.hostname())
    }

    private static _getAlertTypeString(type: SlackAlertType, iconOnly: boolean): string {
